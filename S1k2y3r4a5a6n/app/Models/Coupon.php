...
class Coupon extends Model
{
    ...
    protected $fillable = ['coupon_code','terms_and_condition','count','unlimited_coupon','display_at_checkout','discount','minimum_order','discount_type', 'apply_for','apply_for_ids','status','start_date','end_date','never_expired'];
